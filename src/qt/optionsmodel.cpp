...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("strThirdPartyTxUrls")) {
        if(fTestNet)
            ...
            settings.setValue("strThirdPartyTxUrls", "https://bitinfocharts.com/cultofthedeadcow/tx/%s|https://coinplorer.com/cDc/Transactions/%s|https://explorer.novaco.in/tx/%s");
    }
    strThirdPartyTxUrls = settings.value("strThirdPartyTxUrls", "https://bitinfocharts.com/cultofthedeadcow/tx/%s|https://coinplorer.com/cDc/Transactions/%s|https://explorer.novaco.in/tx/%s").toString();
